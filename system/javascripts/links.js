...
document.write('<tr class="istart_dark" onClick="' + "showHideLayer('mpspwxp','visible')" + '"> <td width="20"><img src="../images/icons/menu/links/pspwxp.png" width="20" height="20" border="0"></td><td><a href="#" class="aistart_dark">PspWxp</a></td><td><img src="../theme_vista/arrow.gif" width="10" height="18"></td></tr>');
