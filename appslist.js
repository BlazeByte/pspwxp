...
//to add an application to the list: on a new line in the list section, add App("App name",1,"App URL",Icon URL,1);
//for more detailed instructions, visit http://pspwxp.co.nr/

// Set the following to 1 to remove the maximize instructions. This applies to both apps and games.
...
App("About pspWxp",1,"apps/about.htm","images/icons/menu/cpanel.png");  
...
App("Clock",1,"apps/clock.htm","images/icons/menu/apps/stopwatch.png"); 
...
App("Flash Calculator",1,"apps/calc.swf","images/icons/menu/vid.png");   
App("Internet",1,"apps/internet/index.htm","images/icons/menu/apps/ie.png");  
App("MSN Messenger",1,"apps/msn/index.htm","images/icons/menu/links/msnmessenger.png");
App("My PSP",1,"apps/filebrowse/index.htm","images/icons/menu/apps/view.png"); 
...
App("PSPTunes",1,"apps/psptunes.htm","images/icons/menu/psptunes.png");  
App("Update",1,"http://pspwxp.atspace.com/updates/"+intVersion+".htm","images/icons/menu/vid.png");  