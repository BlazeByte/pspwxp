...
function showWindow(windowNo,ProgramLocation,ProgramIcon,blncontrol,ProgramTitle,StartMax){
	if(StartMax==0||StartMax==null){
		...
		document.getElementById('imgTab'+windowNo).src='window/tab_down.gif';
...
function hideMenu(){showHideLayer('menu','hidden');showHideLayer('muser','hidden'); showHideLayer('mlinks','hidden');showHideLayer('mpspwxp','hidden');showHideLayer('mportals','hidden'); showHideLayer('mgames','hidden');showHideLayer('mboard','hidden');showHideLayer('mquick','hidden');showHideLayer('mpuzzle','hidden');showHideLayer('mshooting','hidden');showHideLayer('mother','hidden');showHideLayer('mapps','hidden');showHideLayer('startoff','visible');deScr();
}
...
function closeWindow(windowNo){
	frames['progman'+windowNo].location.href='../system/blank.htm';
...
function windowMin(windowNo){
	 ...
	 document.getElementById('imgTab'+windowNo).src='window/tab.gif';
}
