MenuItem("About Encore","../apps/about.htm","images/icons/menu/apps/aboutencore.png");
MenuItem("About " + tName + " Theme","../apps/about.htm","images/icons/menu/apps/abouttheme.png");
